...
$mysqli->query("CREATE TABLE HIERARCHIE (id_hierarchie VARCHAR(20),nom_hierarchie VARCHAR(255),cat_inf VARCHAR(255) NULL, FOREIGN KEY(id_hierarchie) REFERENCES INGREDIENT(id_ingredient))");
...
foreach($Hierarchie as $indice => $ingredient){ //$mysqli->escape_string()
  ...
  if(array_key_exists('sous-categorie', $ingredient)){
    ...
    foreach($super_categ as $sc){  //super-categorie
      ...
      $mysqli->query("INSERT INTO HIERARCHIE (id_hierarchie, nom_hierarchie, cat_inf)
